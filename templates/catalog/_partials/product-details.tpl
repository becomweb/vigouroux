...
<section id="product-details" data-product="{$product.embedded_attributes|json_encode}" class="d-none">
  <div class="product_page_section_title">{l s='Product Details' d='Shop.Theme.Catalog'}</div>
